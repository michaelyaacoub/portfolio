    ...
    <StyledAboutSection id="about" ref={revealContainer}>
      ...
      <div className="inner">
        <StyledText>
          <div>
            <p>
              Hello! My name is Michael, I have passion to develop & learn new technologies for the web.
            ...
            <p> I am more foucsed on #React.js
              However, here are few technologies that I've leared, used @<a href="https://betheltech.net/">betheltech</a>{' '}, and been growing in and working with:</p>
          </div>
